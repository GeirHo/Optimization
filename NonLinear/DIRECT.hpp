...
protected:
  ...
  virtual Algorithm::ID GetAlgorithm( void ) final
	...
	Optimizer( void )
	: Objective(), Bound(), Optimizer< Algorithm::Global::DIRECT::Standard >()
	{}
...
protected:
  ...
  virtual Algorithm::ID GetAlgorithm( void ) override
														  ...
														  Objective::Goal Direction) final
	{
	  ...
	  SetObjective( TheSolver, Direction );
		SetBounds( TheSolver );
		SetInEqConstraints( TheSolver, NumberOfVariables, Tolerance );
...
protected:
  ...
  virtual Algorithm::ID GetAlgorithm( void ) final
	...
	Optimizer( double ConstraintTolerance  )
	: Objective(), Bound(), InequalityConstraints(),
